  ...
  return (
    <div className="px-4 py-2 border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950 w-full">
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-7 gap-3">
        ...
        <div className="flex flex-col text-xs">
        <span className="text-gray-500 dark:text-gray-400 mb-1">Platform</span>
        <select
          value={platform}
        ...
        <div className="flex flex-col text-xs">
        <span className="text-gray-500 dark:text-gray-400 mb-1">Location</span>
        <select
          value={location}
        ...
        <div className="flex flex-col text-xs">
          <span className="text-gray-500 dark:text-gray-400 mb-1">Customer</span>
        <select
          value={customerType}
